  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-500">View grades by quarter.</p>
      </div>
                ...
                return (
                  <tr key={grade.id}>
                    ...
                    <td className="px-4 py-3">
                      {remark.passed === null ? <span className="text-gray-400">—</span> : (
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-4">
        <h2 className="mb-3 text-sm font-semibold text-gray-800">Grading Scale (DepEd)</h2>
