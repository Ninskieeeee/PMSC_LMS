  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-slate-400">Read-only view of all recorded grades.</p>
      </div>
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
            ...
            {grades.map((grade) => {
              ...
              return (
                <tr key={grade.id} className="hover:bg-gray-50 dark:hover:bg-slate-800">
                  <td className="px-4 py-3 font-medium text-gray-900 dark:text-white">{grade.student?.user?.name}</td>
